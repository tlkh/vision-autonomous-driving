...
cascade = cv2.CascadeClassifier('body_cascade.xml')
...
try:
    while True:
        ...
        try:
            ...
            detections = cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=2)
            for (x,y,w,h) in detections:
                cv2.rectangle(feed,(x,y),(x+w,y+h),(0,255,255),1)
